  ...
  useEffect(() => {
    ...
    const fetchExercisesData = async () => {
      ...
      const fetchYoutubeSearchUrl = async () => {
        const exerciseVideosResponse = await fetch(
          `/api/youtubeSearchUrl/${exerciseDetailData.name}`
        );
      ...
      const fetchEquipementExercises = async () => {
        ...
        const equipmentExercisesData = await equipmentExercisesResponse.json();
