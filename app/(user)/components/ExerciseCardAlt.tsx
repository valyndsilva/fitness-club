...
export default function ExerciseCardAlt({ exercise }: Props) {
  return (
    <Link
    ...
    >
      <div
        className={`w-72 h-96 cursor-pointer gap-12 flex flex-col items-center justify-center text-[#3A1212]  font-medium capitalize text-xl bg-white border border-gray-200 rounded-lg px-5 py-2.5 text-center dark:focus:ring-gray-600 mr-2 mb-2`}
      >
        <div className=" transition-all duration-250 ease-in items-center flex flex-col space-y-4 justify-center">
          <img src={exercise?.gifUrl || unavailableImg} alt={exercise?.name} loading="lazy" />
          <div className="flex">
